...
> = T | z.ZodOptional<T> | z.ZodNullable<T> | z.ZodDefault<T> | z.ZodEffects<T>;
...
export type FieldConfig<T extends z.ZodObject<z.ZodRawShape>> = {
...
// DynamicForm props
export interface DynamicFormProps<T extends z.ZodObject<z.ZodRawShape>> {
...
// DynamicForm emits
export interface DynamicFormEmits<T extends z.ZodObject<z.ZodRawShape>> {
