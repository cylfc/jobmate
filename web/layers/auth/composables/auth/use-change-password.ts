...
export function useChangePassword() {
  ...
  const schema = z
    .object({
      currentPassword: z
        .string({
          required_error: t("auth.validation.current-password-required"),
        })
      ...
      confirmPassword: z.string({
        required_error: t("auth.validation.confirm-password-required"),
      }),
    })
  ...
  async function handleSubmit(_event: FormSubmitEvent<ChangePasswordInput>) {
    ...
    try {
      ...
      toast.add({
        title: t(
          "auth.change-password-success-title",
          "Đổi mật khẩu thành công",
        ),
        description: t(
          "auth.change-password-success-description",
      ...
      toast.add({
        ...
        description:
          ...
          t(
            "auth.change-password-error-description",
