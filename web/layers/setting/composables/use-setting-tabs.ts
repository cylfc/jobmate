...
export const useSettingTabs = () => {
  ...
  const tabs = [
    ...
    {
      label: "Security",
      value: "security" as SettingTab,
      icon: "i-lucide-lock",
    },
    {
      label: "Notification",
      value: "notification" as SettingTab,
      icon: "i-lucide-bell",
    },
    {
      label: "System Config",
      value: "system-config" as SettingTab,
  ...
  const selectedTab = computed<SettingTab>(() => {
    ...
    if (
      ...
      allowedTabs.includes(fromQuery as SettingTab)
    ) {
