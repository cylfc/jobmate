  ...
  <section class="space-y-3">
    ...
    <UCard>
      <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <!-- Distribution -->
        <UCard :ui="{ body: 'p-4' }" class="h-full lg:col-span-2">
          <div class="space-y-3">
            <div class="space-y-1">
              <p class="text-sm font-medium text-toned">
                {{ t("dashboard.matching-health.distribution") }}
              </p>
              <p class="text-xs text-muted">
                {{ t("dashboard.matching-health.distribution-hint") }}
              </p>
            </div>
