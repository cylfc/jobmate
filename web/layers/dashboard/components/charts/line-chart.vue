...
const option = computed(() => {
  ...
  const maxValue =
    props.yAxisMax ??
    Math.max(...allValues, 0) * CHART_CALCULATION.MAX_VALUE_MULTIPLIER;
  ...
  return {
    ...
    tooltip: {
      ...
      valueFormatter: ((value: any, _dataIndex: number) => {
          ...
          ? {
              color: {
                ...
                colorStops: [
                  ...
                  {
                    offset: CHART_GRADIENT.COLOR_STOP_END,
                    color: CHART_COLORS.TRANSPARENT,
                  },
                ],
              },
            }
