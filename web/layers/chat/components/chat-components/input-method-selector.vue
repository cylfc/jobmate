<template>
  <div class="space-y-4">
    ...
    <div
      v-else-if="selectedMethod === 'prompt'"
...
const emit = defineEmits<{
  (e: "update", data: { method: string; data?: unknown }): void;
  (e: "clear"): void;
  (e: "back"): void;
}>();
...
const defaultMethods = computed(() => [
  {
    value: "prompt",
    label: t("chat.components.input-method.methods.text"),
    icon: "i-lucide-pencil",
  },
  {
    value: "source",
    label: t("chat.components.input-method.methods.database"),
    icon: "i-lucide-database",
  },
  {
    value: "upload",
    label: t("chat.components.input-method.methods.upload-file"),
...
const uploadComponentRef = ref<{ $el?: HTMLElement } | null>(null);
...
const handleMethodUpdate = (data: unknown) => {
