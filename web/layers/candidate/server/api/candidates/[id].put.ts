...
export default defineEventHandler(async (event) => {
  try {
    ...
    const backendResponse = await apiClient.patch<BackendCandidate>(`/candidates/${id}`, updatePayload, {
    ...
    logError('Error in /api/candidates/[id].put.ts', error, 'candidates.[id].put')
