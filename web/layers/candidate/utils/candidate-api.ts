...
export const useCandidate = () => {
  ...
  const getCandidateById = async (id: string): Promise<Candidate | null> => {
    try {
      const response = await $api<ApiResponse<Candidate>>(
        `/api/candidates/${id}`,
        {
          method: "GET",
        },
  ...
  const updateCandidate = async (
    id: string,
    input: Partial<CreateCandidateInput> & { status?: Candidate["status"] },
  ) => {
    try {
      const response = await $api<ApiResponse<Candidate>>(
        `/api/candidates/${id}`,
   ...
   */
  const parseCandidateFromText = async (
    text: string,
  ...
  const getFilterOptions = async () => {
    try {
      const response = await $api<
        ApiResponse<import("@candidate/types/candidate").CandidateFilterOptions>
  ...
  const getEducation = async (
    ...
    try {
      const response = await $api<ApiResponse<EducationEntry[]>>(
  ...
  const updateEducation = async (
    candidateId: string,
    id: string,
    input: Partial<EducationEntry>,
  ): Promise<EducationEntry> => {
    try {
      const response = await $api<ApiResponse<EducationEntry>>(
        `/api/candidates/${candidateId}/education/${id}`,
        {
          method: "PUT",
          body: input,
        },
  ...
  const getSkills = async (candidateId: string): Promise<SkillEntry[]> => {
    try {
      const response = await $api<ApiResponse<SkillEntry[]>>(
  ...
  const updateSkill = async (
    candidateId: string,
    id: string,
    input: Partial<SkillEntry>,
  ): Promise<SkillEntry> => {
    try {
      const response = await $api<ApiResponse<SkillEntry>>(
        `/api/candidates/${candidateId}/skills/${id}`,
        {
          method: "PUT",
          body: input,
        },
  ...
  const getWorkExperience = async (
    ...
    try {
      const response = await $api<ApiResponse<WorkExperienceEntry[]>>(
        `/api/candidates/${candidateId}/work-experience`,
        {
          method: "GET",
        },
      );
  ...
  const createWorkExperience = async (
    candidateId: string,
    input: Omit<WorkExperienceEntry, "id">,
  ): Promise<WorkExperienceEntry> => {
    try {
      const response = await $api<ApiResponse<WorkExperienceEntry>>(
        `/api/candidates/${candidateId}/work-experience`,
  ...
  const updateWorkExperience = async (
    candidateId: string,
    id: string,
    input: Partial<WorkExperienceEntry>,
  ): Promise<WorkExperienceEntry> => {
    try {
      const response = await $api<ApiResponse<WorkExperienceEntry>>(
        `/api/candidates/${candidateId}/work-experience/${id}`,
        {
          method: "PUT",
          body: input,
        },
  ...
  const getProjects = async (candidateId: string): Promise<ProjectEntry[]> => {
    try {
      const response = await $api<ApiResponse<ProjectEntry[]>>(
        `/api/candidates/${candidateId}/projects`,
        {
          method: "GET",
        },
      );
  ...
  const updateProject = async (
    candidateId: string,
    id: string,
    input: Partial<ProjectEntry>,
  ): Promise<ProjectEntry> => {
    try {
      const response = await $api<ApiResponse<ProjectEntry>>(
        `/api/candidates/${candidateId}/projects/${id}`,
        {
          method: "PUT",
          body: input,
        },
