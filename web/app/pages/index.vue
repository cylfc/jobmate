...
const invitationSchema = z.object({
  ...
  guests: z
    ...
    .default([{ name: "John Doe", email: "john@example.com", plusOne: false }])
    .describe("Guest List"),
});
  ...
  <div class="max-w-4xl mx-auto p-8 space-y-12">
    <div>
      ...
      <p class="text-gray-600">
        Automatically generate forms from Zod schemas with extensible field
        registry
      </p>
    </div>
    ...
    <UCard>
      ...
      >
        <UButton type="submit" class="mt-4"> Save Role </UButton>
      </DynamicForm>
    </UCard>
    ...
    <UCard>
      ...
      <DynamicForm :schema="addressSchema" @submit="handleAddressSubmit">
        <UButton type="submit" class="mt-4"> Save Address </UButton>
      </DynamicForm>
    </UCard>
    ...
    <UCard>
      ...
      <DynamicForm :schema="invitationSchema" @submit="handleInvitationSubmit">
        <UButton type="submit" class="mt-4"> Send Invitations </UButton>
      </DynamicForm>
    </UCard>
    ...
    <UCard>
      ...
      <DynamicForm :schema="surveySchema" @submit="handleSurveySubmit">
        <UButton type="submit" class="mt-4"> Submit Survey </UButton>
      </DynamicForm>
    </UCard>
    ...
    <UCard>
      ...
      >
        <UButton type="submit" class="mt-4"> Save Settings </UButton>
      </DynamicForm>
    </UCard>
  </div>
</template>
